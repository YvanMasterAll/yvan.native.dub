    ...
    return (
      <View style={[styles.pageInfoBottomContainer, this.props.pageInfoBottomContainerStyle]} pointerEvents="none">
        <View style={styles.pageInfoContainer}>
          <View
            style={[styles.pageInfoPill, { backgroundColor: this.props.pageInfoBackgroundColor, flexDirection: 'row' }]}
          >
            {
               _.times(pageLength, (i) => {
                    return (
                      <View
                        key={i}
                        style={{backgroundColor: o.state.currentPage === i? "#2BC329":"#93D2AE", borderRadius: 3, width: 6, height: 6, marginRight: 5}} 
                        />
                    )
                })
            }
