        ...
        return (
            <Grid style={s.container}>
                ...
                <Row style={{padding: 16}}>
                    <Left style={s.verticalCenter}>
                        <Icon name='play-circle-outline' style={{color: priColor_300, fontSize: smIconSize}}/>
                        <Text style={{marginLeft: 4, color: supFontColor_001, fontSize: smFontSize}}>{this.props.hits}</Text>
                    </Left>
                    <View style={{flexDirection: 'row', alignItems: 'center', justifyContent: 'flex-end'}}>
                        <Icon name='thumb-up-outline' style={{color: priColor_300,marginLeft: 8, fontSize: smIconSize}} />
                        <Text style={{marginLeft: 4, color: supFontColor_001, fontSize: smFontSize}}>{this.props.thumbsup}</Text>
                        <Icon name='message-text-outline' style={{color: priColor_300,marginLeft: 8, fontSize: smIconSize}} />
                        <Text style={{marginLeft: 4, color: supFontColor_001, fontSize: smFontSize}}>{this.props.comments}</Text>
                        <Icon name='share-variant' style={{color: priColor_300,marginLeft: 8, fontSize: smIconSize}} />
                        <Text style={{marginLeft: 4, color: supFontColor_001, fontSize: smFontSize}}>分享</Text>
                    </View>
                </Row>
            </Grid>
        )
